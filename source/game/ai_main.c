...
int BotAISetupClient(int client, struct bot_settings_s *settings, qboolean restart) {
	...
	bs->botWeaponWeights[WP_DEMP2] = 11;
	bs->botWeaponWeights[WP_FLECHETTE] = 14;
...
//	bs->botWeaponWeights[WP_TRIP_MINE] = 3;
	...
	bs->botWeaponWeights[WP_AUXILIARY6] = 6;
	bs->botWeaponWeights[WP_AUXILIARY7] = 1;
	bs->botWeaponWeights[WP_AUXILIARY8] = 18;

	bs->botWeaponWeights[WP_AUXILIARY1] = 13;
	bs->botWeaponWeights[WP_AUXILIARY2] = 15;
	bs->botWeaponWeights[WP_AUXILIARY3] = 8;
	bs->botWeaponWeights[WP_AUXILIARY4] = 14;
	bs->botWeaponWeights[WP_AUXILIARY5] = 15;

	bs->botWeaponWeights[WP_AUXILIARY9] = 11;
	bs->botWeaponWeights[WP_AUXILIARY10] = 12;
	bs->botWeaponWeights[WP_AUXILIARY11] = 13;

	bs->botWeaponWeights[WP_BRYAR_OLD] = 15;
	bs->botWeaponWeights[WP_CONCUSSION] = 18;
...
void CommanderBotAI(bot_state_t *bs)
{
	...
	else if (g_gametype.integer == GT_TEAM || g_gametype.integer == GT_HERO)
	{
...
void StandardBotAI(bot_state_t *bs, float thinktime)
{
	...
	if ((bs->cur_ps.ammo[weaponData[bs->cur_ps.weapon].ammoIndex] < weaponData[bs->cur_ps.weapon].energyPerShot ||
			bs->cur_ps.ammo[weaponData[bs->cur_ps.weapon].ammoIndex] < weaponData[bs->cur_ps.weapon].altEnergyPerShot))
	{
