...
//------------------------------
#ifdef AKIMBO
extern void TossClientItems( gentity_t *self, qboolean death, int onlyLeftWeapon );
#else
extern void TossClientItems( gentity_t *self, qboolean death );
#endif
...
#ifdef AKIMBO
						TossClientItems( NPC, qtrue, qfalse );
#else
