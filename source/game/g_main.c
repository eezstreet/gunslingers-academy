...
//[NewMapCycle]
vmCvar_t	g_winnerPicksMap;
//[/NewMapCycle]

//[AnnouncementsSys]
vmCvar_t	g_amessageDelay;
vmCvar_t	g_amessage1;
vmCvar_t	g_amessage2;
vmCvar_t	g_amessage3;
//[/AnnouncementsSys]

//[Lobby]
vmCvar_t	g_pregameLobby;
vmCvar_t	g_pregameLobbyTime;
vmCvar_t	g_pregameLobbyMessage;
vmCvar_t	g_pregameLobbyForceWait;
//[/Lobby]
...
//[Respawn Timer]
vmCvar_t	g_ffaRespawnTimer;
//[/Respawn Timer]

//[HeroPickNew]
vmCvar_t	g_heroPickTime;
//[/HeroPickNew]

//[AdminSys]
vmCvar_t	g_level1Password;
vmCvar_t	g_level2Password;
vmCvar_t	g_level3Password;
vmCvar_t	g_level4Password;
vmCvar_t	g_level5Password;

vmCvar_t	g_superficial;	//Superficial lockdown - prevents any admins from logging in unless their accounts have been cleared.
vmCvar_t	g_lockdown;		//Full lockdown - users cannot log in if this is set.
//[/AdminSys]
...
//[RP]
//Something I added to appease RPers
vmCvar_t	g_barebones;
//[/RP]

vmCvar_t	g_gunRemoveTime;
...
//[Stamina]
vmCvar_t	g_staminaMax;
vmCvar_t	g_staminaRegenRate;
//[/Stamina]
...
static cvarTable_t		gameCvarTable[] = {
	...
	//[Stamina]
	{ &g_staminaMax, "g_staminaMax", "1000", CVAR_ARCHIVE | CVAR_SERVERINFO, 0, qtrue},
	{ &g_staminaRegenRate, "g_staminaRegenRate", "8", CVAR_ARCHIVE, 0, qtrue},
	//[/Stamina]

	//HACKS
	{ &sv_jampDed, "sv_jampDed", "0", CVAR_ARCHIVE | CVAR_LATCH, 0, qtrue},
	
	{ &g_maxForceRank, "g_maxForceRank", "0", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_LATCH, 0, qfalse  },
	...
	//[NewMapCycle]
	{ &g_winnerPicksMap, "g_winnerPicksMap", "0", CVAR_ARCHIVE, 0, qtrue },
	//[/NewMapCycle]

	{ &g_gunRemoveTime, "g_gunRemoveTime", "120", CVAR_ARCHIVE, 0, qtrue },

	//[Lobby]
	{ &g_pregameLobby, "g_pregameLobby", "0", CVAR_ARCHIVE | CVAR_LATCH, 0, qfalse },
	{ &g_pregameLobbyTime, "g_pregameLobbyTime", "5000", CVAR_ARCHIVE | CVAR_LATCH, 0, qfalse },
	{ &g_pregameLobbyMessage, "g_pregameLobbyMessage", "Set g_pregameLobbyMessage to display a message here.", CVAR_ARCHIVE | CVAR_LATCH, 0, qfalse },
	{ &g_pregameLobbyForceWait, "g_pregameLobbyForceWait", "0", CVAR_ARCHIVE, 0, qfalse },
	//[/Lobby]
	...
	{ &g_specInactive, "g_specInactive", "1", CVAR_SERVERINFO, 0, qfalse },
	...
	//[Respawn Timer]
	{ &g_ffaRespawnTimer, "g_ffaRespawnTimer", "0", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qtrue },
	//[/Respawn Timer]

	//[HeroPickNew]
	{ &g_heroPickTime, "g_heroPickTime", "240", CVAR_ARCHIVE, 0, qtrue },
	//[/HeroPickNew]

	//[LastManStanding]
	{ &g_LMS, "g_LMS", "0", CVAR_SERVERINFO | CVAR_LATCH | CVAR_ARCHIVE, 0, qfalse },
	{ &g_LMSlives, "g_LMSlives", "1", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qtrue },
	//[/LastManStanding]

	//[AdminSys]
	{ &g_level1Password, "g_level1Password", "", CVAR_ARCHIVE, 0, qfalse },
	{ &g_level2Password, "g_level2Password", "", CVAR_ARCHIVE, 0, qfalse },
	{ &g_level3Password, "g_level3Password", "", CVAR_ARCHIVE, 0, qfalse },
	{ &g_level4Password, "g_level4Password", "", CVAR_ARCHIVE, 0, qfalse },
	{ &g_level5Password, "g_level5Password", "", CVAR_ARCHIVE, 0, qfalse },

	{ &g_superficial, "g_superficial", "0", CVAR_ARCHIVE, 0, qfalse },
	{ &g_lockdown, "g_lockddown", "0", CVAR_ARCHIVE, 0, qfalse },
	//[/AdminSys]

	{ &g_hardcore, "g_hardcore", "0", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qtrue },

	//[ServerRules]
	{ &g_serverRules, "g_serverRules", "GSA v2.4.4 BETA", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qtrue },
	//[/ServerRules]
	...
	{ &g_forcePowerDisable, "g_forcePowerDisable", "262143", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_LATCH | CVAR_CHEAT, 0, qtrue  },
	{ &g_weaponDisable, "g_oldSchool", "1", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_LATCH, 0, qtrue  },
	...
	//[RP]
	{ &g_barebones, "g_barebones", "0", CVAR_ARCHIVE|CVAR_SERVERINFO|CVAR_LATCH, 0, qfalse },
	//[/RP]
	...
	{ &g_redteam, "g_redteam", "Red", CVAR_ARCHIVE | CVAR_SERVERINFO , 0, qtrue, qtrue },
	{ &g_blueteam, "g_blueteam", "Blue", CVAR_ARCHIVE | CVAR_SERVERINFO , 0, qtrue, qtrue  },
	...
	{ &g_dismember, "g_dismember", "2", CVAR_ARCHIVE, 0, qtrue  },
	{ &g_forceDodge, "g_forceDodge", "1", 0, 0, qtrue  },

	{ &g_noSuicides, "g_noSuicides", "0", CVAR_ARCHIVE, 0, qtrue },
...
// nmckenzie: SABER_DAMAGE_WALLS
	...
	//[AnnouncementsSys]
	{ &g_amessageDelay, "g_amessageDelay", "30000", CVAR_ARCHIVE },
	{ &g_amessage1, "g_amessage1", "Welcome to Gunslinger's Academy.", CVAR_ARCHIVE },
	{ &g_amessage2, "g_amessage2", "Current version: 2.4.4", CVAR_ARCHIVE },
	{ &g_amessage3, "g_amessage3", "Beta", CVAR_ARCHIVE },
	//[/AnnouncementSys]
...
// DUEL_HEALTH
	...
	{ &g_instagib_restrict, "g_instagib_restrict", "3", CVAR_ARCHIVE, 0, qtrue },
	//[/Instagib]
	...
	{ &ojp_clientMOTD, "ojp_clientMOTD", "Welcome to Gunslinger's Academy!\nv: b2.4.4", CVAR_ARCHIVE, 0, qfalse },
	...
	{ &ojp_MOTD, "ojp_MOTD", "This server is running Gunslinger's Academy 2.4.4.\nYour client is out of date.", CVAR_ARCHIVE, 0, qfalse },
	//[/ExpandedMOTD]	
};
...
================
*/
qboolean alphaNumericCheck(const char *check){
	for( ; *check; *check++){
		if(*check >= '0' && *check <= '9')
			continue;
		if(*check >= 'a' && *check <= 'z')
...
In case g_gametype isn't a number, resolve it into being a number.
================
*/
void G_ResolveGametype(void)
{
	if(atoi(g_gametype.string))
	{
		trap_Cvar_Set("g_gametype", g_gametype.string);
		return;
	}

	if(!Q_stricmp(g_gametype.string, "FFA"))
	{
		trap_Cvar_Set("g_gametype", "0");
	}else if(!Q_stricmp(g_gametype.string, "DM")) {
		trap_Cvar_Set("g_gametype", "0");
	} else if(!Q_stricmp(g_gametype.string, "TFFA")) {
		trap_Cvar_Set("g_gametype", "6");
	} else if(!Q_stricmp(g_gametype.string, "TDM")) {
		trap_Cvar_Set("g_gametype", "6");
	} else if(!Q_stricmp(g_gametype.string, "ninja")) {
		trap_Cvar_Set("g_gametype", "2");
	} else if(!Q_stricmp(g_gametype.string, "holocron")) {
		trap_Cvar_Set("g_gametype", "1");
	} else if(!Q_stricmp(g_gametype.string, "duel")) {
		trap_Cvar_Set("g_gametype", "3");
	} else if(!Q_stricmp(g_gametype.string, "pduel")) {
		trap_Cvar_Set("g_gametype", "4");
	} else if(!Q_stricmp(g_gametype.string, "powerduel")) {
		trap_Cvar_Set("g_gametype", "4");
	} else if(!Q_stricmp(g_gametype.string, "coop")) {
		trap_Cvar_Set("g_gametype", "5");
	} else if(!Q_stricmp(g_gametype.string, "co-op")) {
		trap_Cvar_Set("g_gametype", "5");
	} else if(!Q_stricmp(g_gametype.string, "sp")) {
		trap_Cvar_Set("g_gametype", "5");
	} else if(!Q_stricmp(g_gametype.string, "singleplayer")) {
		trap_Cvar_Set("g_gametype", "5");
	} else if(!Q_stricmp(g_gametype.string, "siege")) {
		trap_Cvar_Set("g_gametype", "7");
	} else if(!Q_stricmp(g_gametype.string, "ctf")) {
		trap_Cvar_Set("g_gametype", "8");
	} else if(!Q_stricmp(g_gametype.string, "cty")) {
		trap_Cvar_Set("g_gametype", "9");
	} else if(!Q_stricmp(g_gametype.string, "DOM")) {
		trap_Cvar_Set("g_gametype", "10");
	} else if(!Q_stricmp(g_gametype.string, "domination")) {
		trap_Cvar_Set("g_gametype", "10");
	} else if(!Q_stricmp(g_gametype.string, "vip")) {
		trap_Cvar_Set("g_gametype", "11");
	} else if(!Q_stricmp(g_gametype.string, "escort")) {
		trap_Cvar_Set("g_gametype", "11");
	} else if(!Q_stricmp(g_gametype.string, "hero")) {
		trap_Cvar_Set("g_gametype", "13");
	} else if(!Q_stricmp(g_gametype.string, "HTDM")) {
		trap_Cvar_Set("g_gametype", "13");
	} else if(!Q_stricmp(g_gametype.string, "HTFFA")) {
		trap_Cvar_Set("g_gametype", "13");
	} else {
		trap_Cvar_Set("g_gametype", "0");
	}
...
void G_RegisterCvars( void ) {
	...
	trap_SetConfigstring(CS_LOBBYMESSAGE, g_pregameLobbyMessage.string);
	//[OLDGAMETYPES]
	/*
...
//[/CoOpEditor]
void G_PickHeroes( void ){
	int num;
	int i;
	int numPlayersOnTeam[2] = { 0, 0 };
	int playersOnRed[MAX_CLIENTS-1];
	int playersOnBlue[MAX_CLIENTS-1];
	int redCounter = 0;
	int blueCounter = 0;
	int previousBlueHero = 0;
	int previousRedHero = 0;
	IFNGAME(GT_HERO)
		return;
	if(level.intermissiontime || level.lobbyStartTime)
		return;
	for ( i = 0; i < level.maxclients; i++ )
	{
		if( level.clients[i].pers.connected == CON_CONNECTED && !(g_entities[i].client->ps.pm_type == PM_DEAD) && level.clients[i].sess.sessionTeam == TEAM_RED ){
			playersOnRed[redCounter] = level.clients[i].ps.clientNum;
			redCounter++;
			numPlayersOnTeam[0]++;
		}
		else if( level.clients[i].pers.connected == CON_CONNECTED && !(g_entities[i].client->ps.pm_type == PM_DEAD) && level.clients[i].sess.sessionTeam == TEAM_BLUE ){
			playersOnBlue[blueCounter] = level.clients[i].ps.clientNum;
			blueCounter++;
			numPlayersOnTeam[1]++;
		}
	}
	if(numPlayersOnTeam[0] >= 2 && numPlayersOnTeam[1] >= 2){
		/*player_die(&g_entities[level.redHero], &g_entities[level.redHero], &g_entities[level.redHero], 400, MOD_UNKNOWN );
		trap_UnlinkEntity (&g_entities[level.redHero]);*/
		respawn(&g_entities[level.redHero]);
		previousRedHero = level.redHero;

		if(!numPlayersOnTeam[0])
			goto blueFixer; //No players on this team...wait twice as long
		num = playersOnRed[Q_irand(0, (numPlayersOnTeam[0]-1))];
		level.redHero = num;
		/*player_die(&g_entities[level.redHero], &g_entities[level.redHero], &g_entities[level.redHero], 400, MOD_UNKNOWN );
		trap_UnlinkEntity (&g_entities[level.redHero]);*/
		//respawn(&g_entities[level.redHero]);
		ClientSpawn(&g_entities[level.redHero]);

		/*player_die(&g_entities[level.blueHero], &g_entities[level.blueHero], &g_entities[level.blueHero], 400, MOD_UNKNOWN );
		trap_UnlinkEntity (&g_entities[level.blueHero]);*/
		respawn(&g_entities[level.blueHero]);
		previousBlueHero = level.blueHero;

blueFixer:
		if(!numPlayersOnTeam[1])
			goto traps; //No players on this team...wait twice as long
		num = playersOnBlue[Q_irand(0, (numPlayersOnTeam[1]-1))];
		level.blueHero = num;
		/*player_die(&g_entities[level.blueHero], &g_entities[level.blueHero], &g_entities[level.blueHero], 400, MOD_UNKNOWN );
		trap_UnlinkEntity (&g_entities[level.blueHero]);*/
		//respawn(&g_entities[level.blueHero]);
		ClientSpawn(&g_entities[level.blueHero]);

traps:
		trap_SendServerCommand(-1, "cp \"Arise, new heroes!\n\"");
		trap_SendServerCommand(-1, va("arise r %i", level.redHero));
		trap_SendServerCommand(-1, va("arise b %i", level.blueHero));
		trap_SendServerCommand(previousRedHero, "fixmusic");
		trap_SendServerCommand(previousBlueHero, "fixmusic");
		trap_SendServerCommand(-1, "send_event \"New heroes have been chosen.\n\"");
	}
	else{
		return;
	}
...
//[/BugFix44]
void G_PickRComm( void ){
	int teamNums[MAX_CLIENTS];
	int num;
	int i;
	...
	for ( i = 0; i < level.maxclients; i++ )
	{
		...
		{
			teamNums[numPlayersOnTeam++] = i;
			level.anotherRCommander = qfalse;
			num = teamNums[Q_irand (0, numPlayersOnTeam - 1)];
			player_die(&g_entities[num], &g_entities[num], &g_entities[num], 400, MOD_UNKNOWN);
			trap_UnlinkEntity (&g_entities[num]);
			ClientSpawn(&g_entities[num]);
		}
		if(!numPlayersOnTeam){ //oh fun..we now have to add a counter.
			level.anotherRCommander = qtrue;
		}
	}
	level.redTeamCommander = num;
	trap_SendServerCommand(num, "print \"You are now RED's Commander.\n\"");
	trap_SendServerCommand(num, "cp \"You are now RED's Commander.\n\"");
}
void G_PickBComm( void ){
	int teamNums[MAX_CLIENTS];
	int num;
	int i;
	int numPlayersOnTeam = 0;
	for ( i = 0; i < level.maxclients; i++ )
	{
		if ( level.clients[i].pers.connected == CON_CONNECTED && level.clients[i].sess.sessionTeam == TEAM_BLUE )
		{
			teamNums[numPlayersOnTeam++] = i;
			level.anotherBCommander = qfalse;
			num = teamNums[Q_irand (0, numPlayersOnTeam - 1)];
			player_die(&g_entities[num], &g_entities[num], &g_entities[num], 400, MOD_UNKNOWN);
			trap_UnlinkEntity (&g_entities[num]);
			ClientSpawn(&g_entities[num]);
	...
	level.blueTeamCommander = num;
	trap_SendServerCommand(num, "print \"You are now BLUE's Commander.\n\"");
	trap_SendServerCommand(num, "cp \"You are now BLUE's Commander.\n\"");
}
void G_PickVIP( void ){ //Xycaleth: VIP pick function
	int teamNums[MAX_CLIENTS];
	int num;
	int i;
	int numPlayersOnTeam = 0;
	int gametype = g_gametype.integer;
	if(gametype == GT_VIP_ESCORT){
		for ( i = 0; i < level.maxclients; i++ )
		{
			if ( level.clients[i].pers.connected == CON_CONNECTED && level.clients[i].sess.sessionTeam == TEAM_BLUE )
			{
				teamNums[numPlayersOnTeam++] = i;
				level.anotherVIP = qfalse;
				num = teamNums[Q_irand (0, numPlayersOnTeam - 1)];
				level.vipPlayer = num;
				player_die(&g_entities[num], &g_entities[num], &g_entities[num], 400, MOD_UNKNOWN);
				trap_UnlinkEntity (&g_entities[num]);
		...
		trap_SendServerCommand(num, "print \"You are now the VIP.\n\"");
		trap_SendServerCommand(num, "cp \"You are now the VIP.\n\"");
		trap_SendServerCommand(-1, va("vippb %i", level.vipPlayer));
	}
	else if(gametype == GT_COMMANDER){
		for ( i = 0; i < level.maxclients; i++ )
		{
			if ( level.clients[i].pers.connected == CON_CONNECTED && level.clients[i].sess.sessionTeam == TEAM_BLUE )
			{
...
extern void GSA_InitFriendlyNPCs(void);
void G_InitGame( int levelTime, int randomSeed, int restart ) {
	int					i, x, allWeaponsDisabled;
	vmCvar_t	mapname;
	vmCvar_t	ckSum;
	//[RawMapName]
...
#endif
	//PATCH(IDA_STAT_CAP_SERVERSIDE, unsigned char *, 16);
	...
	//HAX
	if(sv_jampDed.integer > 0)
	{
		PATCH(IDA_WP_CAP_SERVERSIDE_JAMPDED, unsigned char, WP_NUM_WEAPONS);
		//PATCH(IDA_STAT_CAP_SERVERSIDE_JAMPDED, unsigned char, 32);
		//PATCH(IDA_NUM_STAT_CAP_SERVERSIDE_JAMPDED, unsigned char, 32);
	}
	else
	{
		PATCH(IDA_WP_CAP_SERVERSIDE, unsigned char, WP_NUM_WEAPONS);
		//PATCH(IDA_STAT_CAP_SERVERSIDE, unsigned char, 32);
		//PATCH(IDA_NUM_STAT_CAP_SERVERSIDE, unsigned char, 32);
	}
	...
	if(g_gametype.integer == GT_VIP_ESCORT || g_gametype.integer == GT_COMMANDER){ //we do special things.
		trap_Cvar_Set("g_instagib", "0"); //sorry, but instagib is turned off.
		//FIXME: pick a VIP player
	}
	...
	//eezstreet edit
	//Load all of the text files.
	Com_Printf("Loading Databases...\n");
	GSA_LoadWeaponTXT("ext_data/weapons", mapname.string, weaponData);
	Com_Printf("weapons.txt: OK\n");
	GSA_LoadAmmoTXT("ext_data/ammo.txt", ammoData);
	Com_Printf("ammo.txt: OK\n");
	GSA_LoadKillstreakTXT("ext_data/killstreaks", mapname.string, killstreakData);
	Com_Printf("killstreaks: OK\n");
...
// nmckenzie: DUEL_HEALTH: Default.
	...
	for ( x = 0; x < MAX_WEAPONS; x++ ){
		allWeaponsDisabled |= (1 << x);
	}
	trap_Cvar_Set ("g_weaponDisable", va ("%i", allWeaponsDisabled));
	...
	//[/OLDGAMETYPES]
	//VIP Escort
	level.blueTeamCommander = ENTITYNUM_NONE;
	level.redTeamCommander = ENTITYNUM_NONE;
	level.vipPlayer = ENTITYNUM_NONE;
	G_PickVIP();
...
void BeginIntermission( void ) {
	...
	trap_Cvar_VariableStringBuffer("nextmap", nextMapBuffer, 64);
	if(nextMapBuffer)
		trap_SendServerCommand(-1, va("chat \"^3Next map: %s\"", nextMapBuffer));
...
//	qboolean		won = qtrue;
	G_LogPrintf( "Exit: %s\n", string );
	if(g_gametype.integer == GT_VIP_ESCORT || g_gametype.integer == GT_COMMANDER){ //hack: display exit condition for VIP escort
	...
	for (i=0 ; i < numSorted ; i++) {
		...
		if(g_gametype.integer >= GT_TEAM &&
			((level.teamScores[TEAM_RED] > level.teamScores[TEAM_BLUE] && cl->sess.sessionTeam == TEAM_RED) ||
			(level.teamScores[TEAM_BLUE] > level.teamScores[TEAM_RED] && cl->sess.sessionTeam == TEAM_BLUE)))
		{ //We are winrars of a team game.
			if(g_gametype.integer == GT_TEAM)
			{
				trap_SendServerCommand(cl->ps.clientNum, "aprogmulti 1 12 13 14 15 16");
			}
		}
...
void CheckCvars( void ) {
	...
	{
		char buffer[16];
		trap_Cvar_VariableStringBuffer("sv_pure", buffer, sizeof(buffer));
		if(atoi(buffer) != 0)
		{
...
void G_RunFrame( int levelTime ) {
		...
		ojp_ffaRespawnTimerCheck < level.time)
	{
		int i = 0;
		gentity_t *clEnt;
		trap_SendServerCommand(-1, "reinforcements");
		while (i < MAX_CLIENTS)
		{
			clEnt = &g_entities[i];
	...
	//[/FFARespawnTimer]
	IFGAME(GT_HERO){
		if(g_heroPickTime.integer &&
			level.heroPickTime < level.time){
				G_PickHeroes();
				level.heroPickTime = level.time + (g_heroPickTime.integer * 1000);
		}
	}
...
#define CLOAK_REFUEL_RATE		150 //seems fair
	...
	//[Lobby]
	if(g_pregameLobby.integer && g_gametype.integer != GT_SIEGE && g_gametype.integer != GT_DUEL && g_gametype.integer != GT_POWERDUEL && level.numConnectedClients > 0)
		CheckLobby();
	//[/Lobby]
	//[CoOp]
	SiegeCheckTimers();
