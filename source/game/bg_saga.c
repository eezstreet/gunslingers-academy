...
stringID_table_t WPTable[] =
{
	...
	ENUM2STRING(WP_AUXILIARY1),
	ENUM2STRING(WP_AUXILIARY2),
	ENUM2STRING(WP_AUXILIARY3),
	ENUM2STRING(WP_AUXILIARY4),
	ENUM2STRING(WP_AUXILIARY5),
	ENUM2STRING(WP_AUXILIARY6),
	ENUM2STRING(WP_AUXILIARY7),
	ENUM2STRING(WP_AUXILIARY8),
	ENUM2STRING(WP_AUXILIARY9),
	ENUM2STRING(WP_AUXILIARY10),
	ENUM2STRING(WP_AUXILIARY11),
	ENUM2STRING(WP_AUXILIARY12),
	ENUM2STRING(WP_AUXILIARY13),
	"", 0
};
