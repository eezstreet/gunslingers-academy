...
//eezstreet edit: proper updating
#define CURRENT_VERSION			1
//eezstreet end

//VS sometimes bugs with preprocessor definitions, defining it here is a good enough alternative
//#define _RELOADING
...
#define	BASE_1			0x00000001 //base 1 belongs to red
#define BASE_2			0x00000002 //base 2 belongs to red
#define BASE_3			0x00000004 //base 3 belongs to red
#define BASE_4			0x00000008 //base 4 belongs to red
#define BASE_5			0x00000016 //base 5 belongs to red
#define BASE_6			0x00000032 //base 6 belongs to red
#define BASE_7			0x00000064 //base 7 belongs to red
#define BASE_8			0x00000128 //base 8 belongs to red
#define BASE_9			0x00000256 //base 9 belongs to red
#define BASE_10			0x00000512 //base 10 belongs to red
#define BASE_11			0x00001024 //base 11 belongs to red
#define BASE_12			0x00002048 //base 12 belongs to red
#define	POSS_1			0x00000001 //base 1 is possessed
#define POSS_2			0x00000002 //base 2 is possessed
#define POSS_3			0x00000004 //base 3 is possessed
#define POSS_4			0x00000008 //base 4 is possessed
#define POSS_5			0x00000016 //base 5 is possessed
#define POSS_6			0x00000032 //base 6 is possessed
#define POSS_7			0x00000064 //base 7 is possessed
#define POSS_8			0x00000128 //base 8 is possessed
#define POSS_9			0x00000256 //base 9 is possessed
#define POSS_10			0x00000512 //base 10 is possessed
#define POSS_11			0x00001024 //base 11 is possessed
#define POSS_12			0x00002048 //base 12 is possessed
...
typedef struct
{
	...
	char		shortName[64];				// eezstreet edit: Short name used for weapon switching
	char		iconPath[MAX_QPATH];		// eezstreet edit: Custom icon for weapon switching
...
__declspec(dllexport) void	QDECL Com_Error( int level, const char *error, ... );
__declspec(dllexport) void	QDECL Com_Printf( const char *msg, ... );
...
#define MAX_SUB_BSP			16 //rwwRMG - added

#define MAX_FRIENDLY_NPCS	4
...
typedef struct playerState_s {
	...
	int			weaponTime;
#endif
	//warning changed variable
	int			ladder;
	//end warning
	short		weaponChargeSubtractTime;
	short		weaponReloading;
	int			gravity;
	float		speed;
...
//UserInt1 stuff
#define UI1_ATTACKRELEASE		1
#define	UI1_ONESHOTOFF			2 //One shot off
#define	UI1_TWOSHOTOFF			4 //Two shot off
#define UI1_THREESHOTOFF		8
#define UI1_FOURSHOTOFF			16
#define UI1_VALIDFIRE			32 //Complex, don't feel like explaining.
#ifdef AKIMBO
#define UI1_AKIMBOATTACKRELEASE	64 //Used for left weapon's semi auto mode
#define	UI1_AKIMBOVALIDFIRE		128
#endif
...
//[/Linux]
	DOM_ISWHITE = 0,
	DOM_ISRED,			// CTF
	DOM_ISBLUE		// One Flag CTF
};
typedef int domStatus_t;

#define MAX_DOMBASES	3
...
#define EVENT_GENERIC		1 //Generic
#define EVENT_KILL			2 //You killed "X"
#define EVENT_ADMIN			3 //You've been a naughty boy and have been silenced
#define EVENT_STREAK		4 //You killed X number of people in one life
#define EVENT_ACHIEVEMENT	5 //You earned X achievement
#define EVENT_SERVER		6 //Next map is X
...
void Overlord_CheckForErrors(void);
