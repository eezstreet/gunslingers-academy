...
int WeaponReadyAnim[WP_NUM_WEAPONS] =
{
	...
	TORSO_WEAPONREADY2,//TORSO_WEAPONREADY7,//WP_DEMP2,
	...
	//AUXILIARY
	TORSO_WEAPONREADY3//WP_AUXILIARY1,
};
...
int WeaponAttackAnim[WP_NUM_WEAPONS] =
{
	...
	BOTH_ATTACK4,//silly raven, you forgot the CONC RIFLE!!!
	BOTH_ATTACK4,//WP_BRYAR_OLD,
...
void BG_ParseField( BG_field_t *l_fields, const char *key, const char *value, byte *ent )
{
	...
	for ( f=l_fields ; f->name ; f++ ) {
		if ( !Q_stricmp(f->name, key) ) {
			...
			case F_CHARARRAY:
#ifdef QAGAME
				Q_strncpyz((char *)(b+f->ofs), G_NewString(value), MAX_QPATH);
#else
				Q_strncpyz((char *)(b+f->ofs), CG_NewString(value), MAX_QPATH);
#endif
				break;
			//eezstreet end
#ifdef QAGAME
...
/* pickup */	"Inquisitor Mark III Seeker Drone",
		120,
		IT_HOLDABLE,
		HI_SEEKER,
/* precache */ "",
...
/* pickup */	"Neuro-Saav Model TD2.3 Electrobinoculars",
		60,
		IT_HOLDABLE,
		HI_BINOCULARS,
/* precache */ "",
...
/* pickup */	"Portable Assault Sentry",
		120,
		IT_HOLDABLE,
		HI_SENTRY_GUN,
/* precache */ "",
...
/* pickup */	"Portable EWEB Assault Turret",
		120,
		IT_HOLDABLE,
		HI_EWEB,
/* precache */ "",
...
*/
	{
		"weapon_stun_baton", 
		"sound/ui/pickupgun.wav",
        { "models/weapons2/stun_baton/baton_w.glm", 
		0, 0, 0},
/* view */		"models/weapons2/stun_baton/baton.md3", 
/* icon */		weaponData[WP_STUN_BATON].iconPath,
/* pickup */	weaponData[WP_STUN_BATON].weaponName,
		100,
		IT_WEAPON,
		WP_STUN_BATON,
/* precache */ "",
...
*/
	{
		...
		0, 0, 0},
/* view */		"models/weapons2/stun_baton/baton.md3", 
/* icon */		weaponData[WP_MELEE].iconPath,
/* pickup */	weaponData[WP_MELEE].weaponName,
		100,
		IT_WEAPON,
		WP_MELEE,
/* precache */ "",
...
/* icon */		weaponData[WP_SABER].iconPath,
/* pickup */	weaponData[WP_SABER].weaponName,
		100,
		IT_WEAPON,
		WP_SABER,
/* precache */ "",
...
/* icon */		weaponData[WP_BRYAR_PISTOL].iconPath,//"gfx/hud/w_icon_rifle",
/* pickup */	weaponData[WP_BRYAR_PISTOL].weaponName,
		100,
		IT_WEAPON,
		WP_BRYAR_PISTOL,
/* precache */ "",
...
/* icon */		weaponData[WP_CONCUSSION].iconPath,//"gfx/hud/w_icon_rifle",
/* pickup */	weaponData[WP_CONCUSSION].weaponName,
		50,
		IT_WEAPON,
		WP_CONCUSSION,
/* precache */ "",
...
/* icon */		weaponData[WP_BRYAR_OLD].iconPath,//"gfx/hud/w_icon_rifle",
/* pickup */	weaponData[WP_BRYAR_OLD].weaponName,
		100,
		IT_WEAPON,
		WP_BRYAR_OLD,
/* precache */ "",
...
/* icon */		weaponData[WP_BLASTER].iconPath,
/* pickup */	weaponData[WP_BLASTER].weaponName,
		100,
		IT_WEAPON,
		WP_BLASTER,
/* precache */ "",
...
/* icon */		weaponData[WP_DISRUPTOR].iconPath,
/* pickup */	weaponData[WP_DISRUPTOR].weaponName,
		100,
		IT_WEAPON,
		WP_DISRUPTOR,
/* precache */ "",
...
/* icon */		weaponData[WP_BOWCASTER].iconPath,
/* pickup */	weaponData[WP_BOWCASTER].weaponName,
		100,
		IT_WEAPON,
		WP_BOWCASTER,
/* precache */ "",
...
/* icon */		weaponData[WP_REPEATER].iconPath,
/* pickup */	weaponData[WP_REPEATER].weaponName,
		100,
		IT_WEAPON,
		WP_REPEATER,
/* precache */ "",
...
/* icon */		weaponData[WP_DEMP2].iconPath,
/* pickup */	weaponData[WP_DEMP2].weaponName,
		100,
		IT_WEAPON,
		WP_DEMP2,
/* precache */ "",
...
/* icon */		weaponData[WP_FLECHETTE].iconPath,
/* pickup */	weaponData[WP_FLECHETTE].weaponName,
		100,
		IT_WEAPON,
		WP_FLECHETTE,
/* precache */ "",
...
/* icon */		weaponData[WP_ROCKET_LAUNCHER].iconPath,
/* pickup */	weaponData[WP_ROCKET_LAUNCHER].weaponName,
		3,
		IT_WEAPON,
		WP_ROCKET_LAUNCHER,
/* precache */ "",
...
*/
	{
		...
		0, 0 },
/* view */		"models/weapons2/thermal/thermal.md3", 
/* icon */		weaponData[WP_THERMAL].iconPath,
/* pickup */	weaponData[WP_THERMAL].weaponName,
		4,
		IT_WEAPON,
		WP_THERMAL,
/* precache */ "",
...
*/
	{
		...
		0, 0},
/* view */		"models/weapons2/laser_trap/laser_trap.md3", 
/* icon */		weaponData[WP_TRIP_MINE].iconPath,
/* pickup */	weaponData[WP_TRIP_MINE].weaponName,
		3,
		IT_WEAPON,
		WP_TRIP_MINE,
/* precache */ "",
...
/* view */		"models/weapons2/detpack/det_pack.md3", 
/* icon */		weaponData[WP_DET_PACK].iconPath,
/* pickup */	weaponData[WP_DET_PACK].weaponName,
		3,
		IT_WEAPON,
		WP_DET_PACK,
/* precache */ "",
...
/* sounds */ "",
	...
	/*QUAKED weapon_aux1 (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_aux1", 
		"sound/ui/pickupgun.wav",
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY1].iconPath,
/* pickup */	weaponData[WP_AUXILIARY1].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY1,
/* precache */ "",
/* sounds */ "",
	...
	/*QUAKED weapon_aux2 (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_aux2", 
		"sound/ui/pickupgun.wav",
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY2].iconPath,
/* pickup */	weaponData[WP_AUXILIARY2].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY2,
/* precache */ "",
/* sounds */ "",
	...
	/*QUAKED weapon_aux3 (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_aux3", 
		"sound/ui/pickupgun.wav",
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY3].iconPath,
/* pickup */	weaponData[WP_AUXILIARY3].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY3,
/* precache */ "",
/* sounds */ "",
	...
	/*QUAKED weapon_aux4 (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_aux4", 
		"sound/ui/pickupgun.wav",
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY4].iconPath,
/* pickup */	weaponData[WP_AUXILIARY4].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY4,
/* precache */ "",
/* sounds */ "",
...

	{
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY5].iconPath,
/* pickup */	weaponData[WP_AUXILIARY5].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY5,
/* precache */ "",
/* sounds */ "",
...

	{
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY6].iconPath,
/* pickup */	weaponData[WP_AUXILIARY6].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY6,
/* precache */ "",
/* sounds */ "",
...

	{
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY7].iconPath,
/* pickup */	weaponData[WP_AUXILIARY7].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY7,
/* precache */ "",
/* sounds */ "",
...

	{
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY8].iconPath,
/* pickup */	weaponData[WP_AUXILIARY8].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY8,
/* precache */ "",
/* sounds */ "",
...

	{
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY9].iconPath,
/* pickup */	weaponData[WP_AUXILIARY9].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY9,
/* precache */ "",
/* sounds */ "",
...

	{
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY10].iconPath,
/* pickup */	weaponData[WP_AUXILIARY10].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY10,
/* precache */ "",
/* sounds */ "",
...

	{
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY11].iconPath,
/* pickup */	weaponData[WP_AUXILIARY11].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY11,
/* precache */ "",
/* sounds */ "",
...

	{
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY12].iconPath,
/* pickup */	weaponData[WP_AUXILIARY12].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY12,
/* precache */ "",
/* sounds */ "",
...

	{
		...
		0, 0, 0},
/* view */		"models/weapons2/heavy_repeater/heavy_repeater.md3", 
/* icon */		weaponData[WP_AUXILIARY13].iconPath,
/* pickup */	weaponData[WP_AUXILIARY13].weaponName,
		100,
		IT_WEAPON,
		WP_AUXILIARY13,
/* precache */ "",
...
/*QUAKED ammo_emplaced (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
Ammo for Emplaced Gun
Do not place!!
*/
	{
		"ammo_emplaced",
...
/*QUAKED ammo_rpg (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
Ammo for RPG-7
*/
	{
		"ammo_rpg",
...
/* view */		NULL,			
/* icon */		"gfx/mp/ammo_rockets",
/* pickup */	"Rocket Propelled Grenades",
		3,
		IT_AMMO,
		AMMO_RPG,
/* precache */ "",
...
/*QUAKED ammo_msixteen (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
Ammo for M16 Assault Rifle
*/
	{
		"ammo_msixteen",
		"sound/player/pickupenergy.wav",
...
/*QUAKED ammo_milkor (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
Ammo for Milkor Grenade Launcher
*/
	{
		"ammo_milkor",
		"sound/player/pickupenergy.wav",
...
/*QUAKED ammo_shotgun (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
Ammo for Tactical Shotgun
*/
	{
		"ammo_shotgun",
		"sound/player/pickupenergy.wav",
...
/*QUAKED ammo_ak (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
Ammo for AK-101
*/
	{
		"ammo_ak",
...
/*QUAKED ammo_lmg (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
Ammo for M249 SAW LMG
*/
	{
		"ammo_lmg",
		"sound/player/pickupenergy.wav",
...
/*QUAKED ammo_taser (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
Ammo for TASER Stun Gun
*/
	{
		"ammo_taser",
		"sound/player/pickupenergy.wav",
...
/*QUAKED ammo_nine (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
Ammo for 9mm
*/
	{
		"ammo_nine",
		"sound/player/pickupenergy.wav",
        { "models/items/blaster.md3", 
		0, 0, 0},
/* view */		NULL,			
/* icon */		"gfx/mp/ammo_blaster",
/* pickup */	"9mm Ammunition",
		21,
		IT_AMMO,
		AMMO_NINE,
/* precache */ "",
...
qboolean BG_CanItemBeGrabbed( int gametype, const entityState_t *ent, const playerState_t *ps ) {
	...
	weapon = &weaponData[item->giTag];
	yourWeapon = &weaponData[ps->weapon];
	...
	case IT_WEAPON:
		...
		if(weapon->weaponType == WT_OTHER || (yourWeapon->weaponType == WT_OTHER && gametype != GT_JEDIMASTER)){
			return qfalse;
		}
		//[CoOp]
		else {
			...
			else if(!(ps->stats[STAT_WEAPONS] & ( 1 << item->giTag))){
				if(weapon->weaponType == WT_EXPLOSIVE && yourWeapon->weaponType != WT_EXPLOSIVE){
					//It's an explosive, and we don't have an explosive equipped.
					return qfalse;
				} else if(weapon->weaponType != WT_EXPLOSIVE && yourWeapon->weaponType == WT_EXPLOSIVE){
					//It's not an explosive, and we have an explosive equipped.
					return qfalse;
				}
			} else {
				/*if(ps->weapon != item->giTag){
					//Okay...so...we have the weapon...but its not our currently equipped weapon.
					return qfalse;
				}*/
			}
...
void BG_AccuracyDrain( pmove_t *pm, int amount )
{//Drain accuracy safely! (Slightly deceiving)
	if(pm->cmd.buttons & BUTTON_SIGHTS && !(pm->cmd.buttons & BUTTON_SPRINT)) //beta 2 - accuracy doesn't drain if you aim down sights
		return;
	else{
		if (pm->ps->stats[STAT_ACCURACY] < 100)
			pm->ps->stats[STAT_ACCURACY] += amount;

		CAP( pm->ps->stats[STAT_ACCURACY], 100 );
	}
}
