...
extern vmCvar_t	ui_breakingNews;
...
typedef enum{
	...
	bryar2,
	bryar3,
	bryarX1, //Bryar Pistol: Get X head shots
	bryarX2,
	bryarX3,
	blaster1, //Steyr TMP: Get X Kills
	blaster2,
	blaster3,
	blasterx1, //Steyr TMP: Get X head shots
	blasterx2,
	blasterx3,
	ump1, //UMP .45: Get X Kills
	ump2,
	ump3,
	umpx1, //UMP .45: Get X head shots
	umpx2,
	umpx3,
	m16a1, //Repeater: Get X kills (primary)
	m16a2,
	m16a3,
	m16b1, //Repeater: Get X head shots (primary)
	m16b2,
	m16b3,
	m16c1, //Repeater: Kill X people with grenade launcher
	m16c2,
	m16c3,
	demp1, //DEMP: Get X kills
	demp2,
	demp3,
	demp1x, //DEMP: Get X head shots
	demp2x,
	demp3x,
	flechette1, //Flechette: Get X kills
	flechette2,
	flechette3,
	flechette1x, //Flechette: Get X head shots...potential to be a VERY evil achievement...>:D
	flechette2x,
	flechette3x,
	rocket1, //Rocket Launcher: Get X kills
	rocket2,
	rocket3,
	grenade1, //Grenade: Kill X people
	grenade2,
	grenade3,
	plastic1, //C-4: Kill X people
	plastic2,
	plastic3,
	NUM_ACHIEVEMENTS
} achievements;

qboolean cg_achievements[NUM_ACHIEVEMENTS];
...
iAchieve_t myAchievements[256];
char achievementFeeders[1+FEEDER_FEATEARNED-FEEDER_FEATS][64][64]; //holy 3D array, batman
