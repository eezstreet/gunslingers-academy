...
#ifdef _WIN32
/*extern void GSA_OpenALHelloWorld(void);
static void CG_OpenAL_HelloWorld (void) {
	GSA_OpenALHelloWorld();
}*/
#endif
...
static void CG_IngameMenu_f(void)
{
	trap_OpenUIMenu(2);	
}

extern void Xbox_Rumble(short intensity, unsigned int msec);
static void CG_Xbox_Rumble(void)
{
	char buffer[8];
	char timeBuf[8];
	trap_Argv(1, buffer, 8);
	trap_Argv(2, timeBuf, 8);
	Xbox_Rumble((short)atoi(buffer), (unsigned int)atoi(timeBuf));
}
...
static consoleCommand_t	commands[] = {
	...
	//[/SIEGECVARFIX]
	{ "ingameopen", CG_IngameMenu_f },
#ifdef _WIN32
	{ "xbox_rumble", CG_Xbox_Rumble },
	//{ "openal_helloworld", CG_OpenAL_HelloWorld },
#endif
};
...
void CG_InitConsoleCommands( void ) {
	...
	trap_AddCommand ("setprimary");
	trap_AddCommand ("setsecondary");
	trap_AddCommand ("setexplosives");
}
