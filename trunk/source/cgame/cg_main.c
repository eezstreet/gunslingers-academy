...
int hudSkinModificationCount = 1;
...
{
	if(cg.predictedPlayerState.isJediMaster)
		return qfalse;
	else
		return qtrue;
}
...
#include "../namespace_begin.h"
#if !MAC_PORT
extern void ActivateCrashHandler();
#endif
...
vmCvar_t	cgd_swayY;
vmCvar_t	cgd_swayZ;
vmCvar_t	cgd_gunPitch;
vmCvar_t	cgd_gunYaw;
vmCvar_t	cgd_gunRoll;

//XBOX STUFF
vmCvar_t	xbox_power;
vmCvar_t	xbox_rumbleModifier;
vmCvar_t	xbox_sensitivity;
vmCvar_t	xbox_invertXLook;
vmCvar_t	xbox_invertYLook;

vmCvar_t	cg_crosshairStyle;
...
vmCvar_t	cg_fov;
vmCvar_t	cg_zoomFov;
vmCvar_t	cg_compactteamoverlay;
vmCvar_t	cg_progress;

//Debug stuff...eezstreet
vmCvar_t	cgd_swayPitch;
vmCvar_t	cgd_swayYaw;
vmCvar_t	cgd_swayRoll;
vmCvar_t	cgd_swayTimeScale;
vmCvar_t	cgd_swayFrequency;
vmCvar_t	cgd_drawStaminaBar;


vmCvar_t	cg_swingAngles;

vmCvar_t	cg_oldPainSounds;
vmCvar_t	cg_obitInChat;

vmCvar_t	cg_ragDoll;

vmCvar_t	cg_jumpSounds;
vmCvar_t	cg_hudSkins;
...
vmCvar_t	cg_testShakeMS;
vmCvar_t	cg_testShakeIntensity;
...
static cvarTable_t cvarTable[] = { // bk001129
	...
	//XBOX STUFF
	{ &xbox_power, "xbox_power", "0", CVAR_ARCHIVE },
	{ &xbox_rumbleModifier, "xbox_rumbleModifer", "1.0", CVAR_ARCHIVE },
	{ &xbox_sensitivity, "xbox_sensitivity", "1.0", CVAR_ARCHIVE },
	{ &xbox_invertXLook, "xbox_invertXLook", "0", CVAR_ARCHIVE },
	{ &xbox_invertYLook, "xbox_invertYLook", "0", CVAR_ARCHIVE },
	//END XBOX
	{ &cg_simpleItems, "cg_simpleItems", "0", CVAR_ARCHIVE },
	{ &cg_addMarks, "cg_marks", "1", CVAR_ARCHIVE },
	{ &cg_lagometer, "cg_lagometer", "0", CVAR_ARCHIVE },
	{ &cg_gun_x, "cg_gunX", "5", CVAR_CHEAT }, //ugly (hacksy) way of dealing with gun sway
	{ &cg_gun_y, "cg_gunY", "-3", CVAR_CHEAT },
	{ &cg_gun_z, "cg_gunZ", "1", CVAR_CHEAT },
	//[AdminSys]
	...
	{ &cg_bobpitch, "cg_bobpitch", "0.002", CVAR_CHEAT },
	{ &cg_bobroll, "cg_bobroll", "0.002", CVAR_CHEAT },
	{ &cg_bobx , "cg_bobx", "0", CVAR_CHEAT },
	{ &cg_boby, "cg_boby", "0", CVAR_CHEAT },
	{ &cg_bobz, "cg_bobz", "0", CVAR_CHEAT },
	{ &cgd_swayX , "cgd_swayX", "0", CVAR_CHEAT },
	{ &cgd_swayY, "cgd_swayY", "0", CVAR_CHEAT },
	{ &cgd_swayZ, "cgd_swayZ", "0", CVAR_CHEAT },
	{ &cgd_gunPitch, "cgd_gunPitch", "0", CVAR_CHEAT },
	{ &cgd_gunYaw, "cgd_gunYaw", "0", CVAR_CHEAT },
	{ &cgd_gunRoll, "cgd_gunRoll", "0", CVAR_CHEAT },

	{ &cg_crosshairStyle, "cg_crosshairStyle", "0", CVAR_ARCHIVE },
	...
	{ &cg_compactteamoverlay, "cg_compactteamoverlay", "0", CVAR_ARCHIVE },
	{ &cg_progress, "cg_progress", "1", CVAR_ARCHIVE },

	{ &cgd_swayPitch, "cgd_swayPitch", "0", CVAR_CHEAT},
	{ &cgd_swayYaw, "cgd_swayYaw", "0", CVAR_CHEAT},
	{ &cgd_swayRoll, "cgd_swayRoll", "0", CVAR_CHEAT},
	{ &cgd_swayTimeScale, "cgd_swayTimeScale", "0", CVAR_CHEAT},
	{ &cgd_swayFrequency, "cgd_swayFrequency", "0", CVAR_CHEAT},
	{ &cgd_drawStaminaBar, "cgd_drawStaminaBar", "0", CVAR_ARCHIVE},

	{ &cg_oldPainSounds, "cg_oldPainSounds", "0", 0 },
	{ &cg_obitInChat, "cg_obitInChat", "1", 0 },

	{ &cg_ragDoll, "broadsword", "1", 0 },

	{ &cg_jumpSounds, "cg_jumpSounds", "1", 0 },
	{ &cg_hudSkins, "cg_hudSkins", "0", CVAR_ARCHIVE },
...
#ifdef GSABETA
	//[Beta]
	{ &r_beta, "r_beta", "1", CVAR_ARCHIVE|CVAR_ROM },
	//[/Beta]
#endif
...
//	{ &cg_singlePlayerActive, "ui_singlePlayerActive", "0", CVAR_USERINFO},
	...
	{ &cg_testShakeMS, "cg_testShakeMS", "0", CVAR_CHEAT },
	{ &cg_testShakeIntensity, "cg_testShakeIntensity", "0", CVAR_CHEAT },

	{ &cg_color1, "cg_color1", "red", CVAR_ARCHIVE },
	{ &cg_color2, "cg_color2", "green", CVAR_ARCHIVE },
	{ &cg_color3, "cg_color3", "yellow", CVAR_ARCHIVE },
	{ &cg_color4, "cg_color4", "blue", CVAR_ARCHIVE },
	{ &cg_color5, "cg_color5", "cyan", CVAR_ARCHIVE },
	{ &cg_color6, "cg_color6", "purple", CVAR_ARCHIVE },
	{ &cg_color7, "cg_color7", "white", CVAR_ARCHIVE },
	{ &cg_color8, "cg_color8", "black", CVAR_ARCHIVE },
...
//[/SFXSabers]
	...
	{ &s_ext_volume, "s_ext_volume", "0.8", CVAR_ARCHIVE },
...
void CG_RegisterCvars( void ) {
	...
	hudSkinModificationCount = cg_hudSkins.modificationCount;
...
=================
*/
extern void onHudSkinCvarChange(void);
void CG_UpdateCvars( void ) {
	...
	//Hud Skins
	if(hudSkinModificationCount != cg_hudSkins.modificationCount )
	{
		hudSkinModificationCount = cg_hudSkins.modificationCount;
		onHudSkinCvarChange();
	}
	//Hud Skins end
	PaletteChange(1, cg_color1.string);
	PaletteChange(2, cg_color2.string);
	PaletteChange(3, cg_color3.string);
	PaletteChange(4, cg_color4.string);
	PaletteChange(5, cg_color5.string);
	PaletteChange(6, cg_color6.string);
	PaletteChange(7, cg_color7.string);
	PaletteChange(0, cg_color8.string);
...
static void CG_RegisterSounds( void ) {
	...
	cgs.media.weaponModeSwapSound = trap_S_RegisterSound( "sound/weapons/fm_change.wav");
	...
	cgs.media.doorLockedSound = trap_S_RegisterSound( "sound/movers/door_locked" );
	cgs.media.doorUnlockedSound = trap_S_RegisterSound( "sound/movers/door_unlocked" );

	cgs.media.hackerIconShader			= trap_R_RegisterShaderNoMip("gfx/mp/c_icon_tech");

	cgs.media.loadBarShader				= trap_R_RegisterShader( "gfx/load/loadingscreena" );
	...
	//[BloodSight]
	cgs.media.bloodSight				= trap_R_RegisterShader("gfx/2d/bloodsight/base2");
	cgs.media.bloodSight1				= trap_R_RegisterShader("gfx/2d/bloodsight/blood1");
	cgs.media.bloodSight2				= trap_R_RegisterShader("gfx/2d/bloodsight/blood2");
	cgs.media.bloodSight3				= trap_R_RegisterShader("gfx/2d/bloodsight/blood3");
	//[/Bloodsight]

#ifdef GSABETA
	cgs.media.betaShader				= trap_R_RegisterShader( "gfx/2d/beta");
#endif

	//[PingIcon]
	cgs.media.pingIcon1				= trap_R_RegisterShader("gfx/scoreboard/ping1");
	cgs.media.pingIcon2				= trap_R_RegisterShader("gfx/scoreboard/ping2");
	cgs.media.pingIcon3				= trap_R_RegisterShader("gfx/scoreboard/ping3");
	cgs.media.pingIcon4				= trap_R_RegisterShader("gfx/scoreboard/ping4");
	//[/PingIcon]
...
#endif
		cgs.media.redLeadsSound = trap_S_RegisterSound( "sound/gunslinger/team/goodLeadSound");
		cgs.media.blueLeadsSound = trap_S_RegisterSound( "sound/gunslinger/team/badLeadSound");
		cgs.media.teamsTiedSound = trap_S_RegisterSound( "sound/gunslinger/team/neutralSound" );
		//eezstreet edit
		//Sets three primary sounds: goodSound.wav, badSound.wav, and neutralSound.wav
		//Blue team is evil, so to speak. This doesn't have any actual effect on the game, other than setting our paths.
		//TODO: remove all this useless garbage, and also add a localized sound effect for the /per team/ basis
		cgs.media.redScoredSound = trap_S_RegisterSound( "sound/gunslinger/team/goodLeadSound");
		cgs.media.blueScoredSound = trap_S_RegisterSound( "sound/gunslinger/team/badLeadSound" );

		if ( cgs.gametype == GT_CTF || cg_buildScript.integer ) {
			cgs.media.redFlagReturnedSound = trap_S_RegisterSound( "sound/gunslinger/team/badSound" );
			cgs.media.blueFlagReturnedSound = trap_S_RegisterSound( "sound/gunslinger/team/goodSound" );
			cgs.media.redTookFlagSound = trap_S_RegisterSound( "sound/gunslinger/team/goodSound" );
			cgs.media.blueTookFlagSound = trap_S_RegisterSound( "sound/gunslinger/team/badSound" );
		}
	...
	cgs.media.airStrikeRewardSound = trap_S_RegisterSound("sound/gunslinger/killstreak/killstreak_airstrike");
	cgs.media.ewebRewardSound = trap_S_RegisterSound("sound/gunslinger/killstreak/killstreak_eweb");
	cgs.media.helicopterRewardSound = trap_S_RegisterSound("sound/gunslinger/killstreak/killstreak_helicopter");
	cgs.media.radarRewardSound = trap_S_RegisterSound("sound/gunslinger/killstreak/killstreak_radar");
	cgs.media.sentryRewardSound = trap_S_RegisterSound("sound/gunslinger/killstreak/killstreak_sentry");
	...
	cgs.media.teamTalkSound	= trap_S_RegisterSound( "sound/gunslinger/player/teamtalk.wav");
	...
	cgs.media.poofSound		= trap_S_RegisterSound( "sound/impact.wav" );
...
//#endif
	...
	for ( i = 0; i < 25; i++){
		cgs.media.ammoTics[i]				= trap_R_RegisterShaderNoMip( data.hud.ammo.ammoTicFiles[i]);
	}

	for( i = 0; i < WP_NUM_WEAPONS; i++){
		cgs.media.weaponSwapIcons[i] = trap_R_RegisterShaderNoMip( va("%s", weaponData[i].swapIconPath));
	}
	...
	cgs.media.fonts.weaponSwitchFont = trap_R_RegisterFont("fonts/capture-it");
	...
	//[GrenadeIndicators]
	cgs.media.grenadeIndicatorShader	= trap_R_RegisterShader( "gfx/2d/grenadeindicator" );
	//[/GrenadeIndicator]

	cgs.media.leaderLineArrowShader		= trap_R_RegisterShader( "gfx/2d/leader/arrow" );
	...
	{
		//[NewTeamOverlay]
		cgs.media.teamOverlay.ak_green = trap_R_RegisterShader( "gfx/team_overlay/icon_ak_green" );
		cgs.media.teamOverlay.ak_yellow = trap_R_RegisterShader( "gfx/team_overlay/icon_ak_yellow" );
		cgs.media.teamOverlay.ak_orange = trap_R_RegisterShader( "gfx/team_overlay/icon_ak_orange" );
		cgs.media.teamOverlay.ak_red = trap_R_RegisterShader( "gfx/team_overlay/icon_ak_red" );
		cgs.media.teamOverlay.c4_green = trap_R_RegisterShader( "gfx/team_overlay/icon_c4_green" );
		cgs.media.teamOverlay.c4_yellow = trap_R_RegisterShader( "gfx/team_overlay/icon_c4_yellow" );
		cgs.media.teamOverlay.c4_orange = trap_R_RegisterShader( "gfx/team_overlay/icon_c4_orange" );
		cgs.media.teamOverlay.c4_red = trap_R_RegisterShader( "gfx/team_overlay/icon_c4_red" );
		cgs.media.teamOverlay.dead = trap_R_RegisterShader( "gfx/team_overlay/icon_dead" );
		cgs.media.teamOverlay.grenade_green = trap_R_RegisterShader( "gfx/team_overlay/icon_grenade_green" );
		cgs.media.teamOverlay.grenade_yellow = trap_R_RegisterShader( "gfx/team_overlay/icon_grenade_yellow" );
		cgs.media.teamOverlay.grenade_orange = trap_R_RegisterShader( "gfx/team_overlay/icon_grenade_orange" );
		cgs.media.teamOverlay.grenade_red = trap_R_RegisterShader( "gfx/team_overlay/icon_grenade_red" );
		cgs.media.teamOverlay.m16_green = trap_R_RegisterShader( "gfx/team_overlay/icon_m16_green" );
		cgs.media.teamOverlay.m16_yellow = trap_R_RegisterShader( "gfx/team_overlay/icon_m16_yellow" );
		cgs.media.teamOverlay.m16_orange = trap_R_RegisterShader( "gfx/team_overlay/icon_m16_orange" );
		cgs.media.teamOverlay.m16_red = trap_R_RegisterShader( "gfx/team_overlay/icon_m16_red" );
		cgs.media.teamOverlay.misc_green = trap_R_RegisterShader( "gfx/team_overlay/icon_misc_green" );
		cgs.media.teamOverlay.misc_yellow = trap_R_RegisterShader( "gfx/team_overlay/icon_misc_yellow" );
		cgs.media.teamOverlay.misc_orange = trap_R_RegisterShader( "gfx/team_overlay/icon_misc_orange" );
		cgs.media.teamOverlay.misc_red = trap_R_RegisterShader( "gfx/team_overlay/icon_misc_red" );
		cgs.media.teamOverlay.saw_green = trap_R_RegisterShader( "gfx/team_overlay/icon_saw_green" );
		cgs.media.teamOverlay.saw_yellow = trap_R_RegisterShader( "gfx/team_overlay/icon_saw_yellow" );
		cgs.media.teamOverlay.saw_orange = trap_R_RegisterShader( "gfx/team_overlay/icon_saw_orange" );
		cgs.media.teamOverlay.saw_red = trap_R_RegisterShader( "gfx/team_overlay/icon_saw_red" );
		cgs.media.teamOverlay.shotgun_green = trap_R_RegisterShader( "gfx/team_overlay/icon_shotgun_green" );
		cgs.media.teamOverlay.shotgun_yellow = trap_R_RegisterShader( "gfx/team_overlay/icon_shotgun_yellow" );
		cgs.media.teamOverlay.shotgun_orange = trap_R_RegisterShader( "gfx/team_overlay/icon_shotgun_orange" );
		cgs.media.teamOverlay.shotgun_red = trap_R_RegisterShader( "gfx/team_overlay/icon_shotgun_red" );
		cgs.media.teamOverlay.sniper_green = trap_R_RegisterShader( "gfx/team_overlay/icon_sniper_green" );
		cgs.media.teamOverlay.sniper_yellow = trap_R_RegisterShader( "gfx/team_overlay/icon_sniper_yellow" );
		cgs.media.teamOverlay.sniper_orange = trap_R_RegisterShader( "gfx/team_overlay/icon_sniper_orange" );
		cgs.media.teamOverlay.sniper_red = trap_R_RegisterShader( "gfx/team_overlay/icon_sniper_red" );
		cgs.media.teamOverlay.ump_green = trap_R_RegisterShader( "gfx/team_overlay/icon_ump_green" );
		cgs.media.teamOverlay.ump_yellow = trap_R_RegisterShader( "gfx/team_overlay/icon_ump_yellow" );
		cgs.media.teamOverlay.ump_orange = trap_R_RegisterShader( "gfx/team_overlay/icon_ump_orange" );
		cgs.media.teamOverlay.ump_red = trap_R_RegisterShader( "gfx/team_overlay/icon_ump_red" );
		//[/NewTeamOverlay]
	}
	...
	cgs.effects.mLimbBolton = trap_FX_RegisterEffect("saber/limb_bolton.efx");
	...
	if ( cgs.gametype >= GT_TEAM || cg_buildScript.integer ) {
		cgs.media.teamRedShader = trap_R_RegisterShader( va("gfx/teams/team_%s", Info_ValueForKey(info, "g_redteam")) );
		cgs.media.teamBlueShader = trap_R_RegisterShader( va("gfx/teams/team_%s", Info_ValueForKey(info, "g_blueteam")) );
	...
	cgs.media.updateSound			= trap_S_RegisterSound("sound/interface/ammocon_done");
...
*/
	...
	cgs.media.pregameLobbyBackground	= trap_R_RegisterShader( "gfx/ui/pregameLobbyBackground.png" );
...
static int CG_OwnerDrawWidth(int ownerDraw, float scale) {
	...
	switch (ownerDraw) {
	  ...
	  case CG_KILLER:
			...
			break;
	  case CG_RED_NAME:
			s = Info_ValueForKey( info, "g_redteam" );
			return CG_Text_Width(/*DEFAULT_REDTEAM_NAMEcg_redTeamName.string*/ s, scale, FONT_MEDIUM);
			break;
	  case CG_BLUE_NAME:
			s = Info_ValueForKey( info, "g_blueteam" );
			return CG_Text_Width(/*DEFAULT_BLUETEAM_NAMEcg_blueTeamName.string*/ s, scale, FONT_MEDIUM);
			break;
...
//[/WEAPONSDAT]
extern void loadIniFile(const char *fileName);
#ifdef ACHIEVEMENTS
extern void GSA_InitiateAchievements(void);
#endif
extern void Xbox_Multithread_Init(void);
#include "hackinglocations.h"
/*
=================
CG_Init
...
void CG_Init( int serverMessageNum, int serverCommandSequence, int clientNum )
{
	...
	//HAX
	PATCH(IDA_WP_CAP_CLIENTSIDE, unsigned char, WP_NUM_WEAPONS);
	//PATCH(IDA_STAT_CAP_CLIENTSIDE, unsigned char, 32);
	//PATCH(IDA_NUM_STAT_CAP_CLIENTSIDE, unsigned char, 32);
	...
	GSA_InitAdvSoundSystem();
	cgs.media.loadScreenMusic = GSA_RegisterAdvSound("soundadv/music/ambience/load.wav");
	GSA_PlaySoundIndex(cgs.media.loadScreenMusic, qtrue, ADVCHAN_MUSIC);

	//All of init'ing one variable...
	//This ought to hurt performance *chuckle*
	InitPlayerSounds();
	BG_CreateDoorSoundIndeces();
...
//	CG_LoadFonts();
	...
	cgDC.Assets.qhDigitalFont = trap_R_RegisterFont("criovision");
	...
	cg.gunViewAngles[0] = 0;
	cg.gunViewAngles[1] = 0;
	cg.gunViewAngles[2] = 0;
	...
	//cgs.media.rageRecShader = trap_R_RegisterShader("gfx/mp/f_icon_ragerec");
...
//	CG_LoadingString( "collision map" );
	...
	CG_LoadingString("Weapon Data");
	Com_Printf("Loading Databases...\n");
	GSA_LoadWeaponTXT("ext_data/weapons", cgs.mapname, weaponData);
	GSA_BuildWeaponsArrays();
	Com_Printf("weapons.txt: OK\n");
	CG_LoadingString("Ammo Data");
	GSA_LoadAmmoTXT("ext_data/ammo.txt", ammoData);
	Com_Printf("ammo.txt: OK\n");
	CG_LoadingString("Killstreak Data");
	GSA_LoadKillstreakTXT("ext_data/killstreaks", cgs.mapname, killstreakData);
	Com_Printf("killstreak file: OK\n");
	GSA_LoadMODTXT("ext_data", "meansofdeath.txt", modData);
	Com_Printf("Means of Death: OK\n");

	CG_LoadingString("Weapon Icons");
	//Code moved
	i = WP_NONE+1;
...
#ifdef AKIMBO
			cgs.media.akimboWeaponIcons[i] = trap_R_RegisterShaderNoMip(va("%s_akimbo", item->icon));
#endif
			//cgs.media.weaponIcons_NA[i] = trap_R_RegisterShaderNoMip(va("%s_na", item->icon));
		}
		else
		{ //make sure it is zero'd (default shader)
			//FIXME: WHY?! The shader system already DOES this!
			cgs.media.weaponIcons[i] = 0;
			//cgs.media.weaponIcons_NA[i] = 0;
		}
		i++;
	}
	cgs.media.noAmmoIcon = trap_R_RegisterShaderNoMip( "gfx/weapon_icons/noammo" );

	String_Init();

	cg.loading = qtrue;		// force players to load instead of defer

	CG_RegisterLadders ( );		// FIXME
...
//	CG_LoadingString( "Creating automap data" );
	...
	GSA_FadeOutSound(cgs.media.loadScreenMusic, 0.0015f);

#ifdef ACHIEVEMENTS
	GSA_InitiateAchievements();
#endif
	cg.acSaveTime = cg.time;

	//Xbox_Multithread_Init();
}
...
#if !MAC_PORT
extern void DeactivateCrashHandler();
extern void Xbox_Multithread_Exit(void);
#endif
void CG_Shutdown( void ) 
{
...
//	Com_Printf("... FX System Cleanup\n");
	...
	GSA_ShutdownAdvSoundSystem();
#if !MAC_PORT
	//XBOX 360 controller stuff
	Xbox_Multithread_Exit();
...
void CG_NextForcePower_f( void ) 
{
	...
	if(cgs.gametype != GT_HOLOCRON && cgs.gametype != GT_JEDIMASTER)
		return;
	if(cgs.gametype != GT_JEDIMASTER && !cg.predictedPlayerState.isJediMaster)
		return;
...
//	if (cg.snap->ps.fd.pd[cg.snap->ps.fd.forcePowerSelected]->startingRank > 0)// & (1 << cg.snap->ps.fd.forcePowerSelected))
