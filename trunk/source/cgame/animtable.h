...
//===End Saber locks==================================================================
	...
	//GUNSLINGERS ACADEMY ANIMS
#ifdef AKIMBO
	ENUM2STRING(BOTH_AKIMBO_AIM),
	ENUM2STRING(BOTH_AKIMBO_SHOT_PISTOL_RIGHT),
	ENUM2STRING(BOTH_AKIMBO_SHOT_PISTOL_LEFT),
	ENUM2STRING(BOTH_AKIMBO_SHOT_PISTOL_BOTH),
	ENUM2STRING(BOTH_AKIMBO_SHOT_MP_RIGHT),
	ENUM2STRING(BOTH_AKIMBO_SHOT_MP_LEFT),
	ENUM2STRING(BOTH_AKIMBO_SHOT_MP_BOTH),
#endif
	ENUM2STRING(BOTH_HIRMAN_STANCE_LOWERED),
	ENUM2STRING(BOTH_HIRMAN_STANCE_RAISED),
	ENUM2STRING(BOTH_HIRMAN_ANIM_LOWERTOUP),
	ENUM2STRING(BOTH_HIRMAN_ANIM_ATTACK),
	ENUM2STRING(BOTH_HIRMAN_ANIM_IDLE),
