...
-------------------------
*/
static void IcarusSetTextColor ( vec4_t textcolor,const char *color)
{
...
{
	IcarusSetTextColor(textcolor_caption,color);
}
...
{
	IcarusSetTextColor(textcolor_center,color);
}
...
{
	IcarusSetTextColor(textcolor_scroll,color);
}
