...
#define CURRENT_OJPBASIC_CLIENTVERSION			"Gunslingers Academy Alpha 1"
//[/ClientPlugInDetect]
...
#define CS_EFFECTS				(CS_PARTICLES+1)
...
#define CS_NPCS					(CS_CAMERA + 1)
#define CS_LOBBYMESSAGE			(CS_NPCS + MAX_FRIENDLY_NPCS)

//[Ladders]
//Ladder code is well, messy at best.
#define CS_LADDERS			(CS_LOBBYMESSAGE + 1)
...
//[/Linux]
	...
	GT_VIP_ESCORT,		// VIP escort
	GT_COMMANDER,		// commander escort
	GT_HERO,			// hero TFFA
	GT_MAX_GAME_TYPE
};
...
//[Ladders]
#define PMF_LADDER			32768		// On a ladder
#define PMF_LADDER_JUMP		65536		// Jumped off a ladder
//[/Ladders]
...
#define	EF_SPRINTING			(1<<15)		// sprinting?
...
#define	EF2_LASER_SIGHT			(1<<8)		// Using laser sights?
#define EF2_SWAPPABLE_WEAPON	(1<<9)		// swappable weapon?
#define EF2_UNNOTICABLE			(1<<10)		// Can be targeted by crosshairs?
#define EF2_LEADERLINES			(1<<11)		// Has an associated leader line?
...
//[/Linux]
	...
	//I'm causing a very obvious desync here, but whatever. The client doesn't need to know about this.
	PW_NUM_POWERUPS
...
//[/Linux]
	...
	HI_SEEKER,			//Helicopters or aerial attack vehicles
	HI_SHIELD,
	HI_MEDPAC,
	HI_MEDPAC_BIG,
	HI_BINOCULARS,		//Anything involving sight
	HI_SENTRY_GUN,		//Stationary shooting guns
	HI_JETPACK,

	HI_HEALTHDISP,
	HI_AMMODISP,
	HI_EWEB,			//Portable Machine Guns
	HI_CLOAK,			//Cloaking Devices
	
	HI_AIRSTRIKE,		//All forms of airstrikes (including drones)
...
typedef enum {
	...
	EV_RADAR_SHOTPING,		// someone is shooting. Ping the radar!
...
// means of death
typedef enum { //head shots code included
	MOD_UNKNOWN,
	MOD_STUN_BATON,
	MOD_MELEE,
	MOD_SABER,
	...
	MOD_DISRUPTOR_HEAD,		//hs
	MOD_BOWCASTER,
	MOD_BOWCASTER_HEAD,		//hs
	MOD_REPEATER,
	MOD_REPEATER_ALT,
	MOD_REPEATER_ALT_SPLASH,
	MOD_REPEATER_HEAD,		//hs
	MOD_DEMP2,
	MOD_DEMP2_ALT,
	MOD_DEMP2_HEAD,			//hs
	MOD_FLECHETTE,
	MOD_FLECHETTE_ALT_SPLASH,
	MOD_FLECHETTE_HEAD,		//hs
	MOD_ROCKET,
	MOD_ROCKET_SPLASH,
	MOD_ROCKET_HOMING,
...
typedef struct gitem_s {
	...
	qboolean	ready;			//ready to be picked up.
} gitem_t;
...
typedef enum {
	...
	//eezstreet edit, special thanks to Xycaleth
	F_CHARARRAY,
	//eezstreet end
	F_IGNORE
} fieldtype_t;
...
void		BG_AccuracyDrain( pmove_t *pm, int amount );	//Helper func for draining weapon accuracy
...
extern void BG_CreateDoorSoundIndeces(void);
extern int BG_GetDoorSoundIndex(char *compText);
extern void BG_GetDoorSoundName(int doorNum, char *buffer);
...
#ifndef QAGAME
typedef struct achieve_s
{
	char name[64];
	char description[256];
	unsigned short acquireCount;
	char achieveSound[64];
	char achieveIcon[64];
	unsigned int feeder;
	void (*onAchieve)(qboolean);
	void **userVars;
} achieve_t;

typedef struct iAchieve_s
{
	achieve_t *baseData;
...
#define A_M162		8
#define A_M163		9
#define A_RECONNAISSANCE	10
#define A_SENTRY	11
#define A_WINTFFA1	12
#define A_WINTFFA2	13
#define A_WINTFFA3	14
#define A_WINTFFA4	15
#define A_WINTFFA5	16
#define F_DEVPLAY	17
#define A_POINT1	18
#define A_POINT2	19
#define A_POINT3	20
...
#define A_AK2		32
#define A_AK3		33
#define A_GRENADE1	34
#define A_GRENADE2	35
#define A_GRENADE3	36
#define A_GRENADE4	37
#define A_GRENADE5	38
#define A_MAGHS1	39
#define A_MAGHS2	40
#define A_MAGHS3	41
#define A_M14HS1	42
...
#define A_M98CHS2	46
#define A_M98CHS3	47
#define A_VALENTINE	48
#define A_IDES		49
#define A_MEMORIAL	50
#define A_JULY4		51
#define A_HALLOWEEN	52
#define A_VETERANS	53
#define A_PEARL		54
#define A_GAS1		55
#define A_GAS2		56
#define A_GAS3		57
#define A_OPENHOUSE	58
#define A_ANYMEANS	59
#define A_MAX		60
