...
{//attack our enemy!
	...
	{//face
		...
		CalcEntitySpot( NPC->enemy, (spot_t)Q_irand(SPOT_CHEST, SPOT_LEGS), enemy_org );
		...
		{//jedi and heavy weapons guys never surrender
			...
			{//they have a weapon so they'd have to drop it to surrender
				...
				{//don't give up unless facing enemy and he's very close
					...
					else if ( DistanceSquared( NPC->r.currentOrigin, NPC->enemy->r.currentOrigin ) > 512*512/*256*256*/ )
					{//they're not close
						return qfalse;
					}
