...
BG_field_t fields[] = {
	...
	{"letter", FOFS(s.generic1), F_LSTRING}, //for domination bases
	{"index", FOFS(s.userInt1), F_INT}, //for domination bases
...
//[NewEntities1]
void SP_trigger_lose (gentity_t *ent);
...
//[Domination]
/*void SP_trigger_domination_field(gentity_t *self);
//[/Domination]

//[Domination]
void SP_target_domination_a( gentity_t *ent);
void SP_target_domination_b( gentity_t *ent);
void SP_target_domination_c( gentity_t *ent);*/
//[/Domination]
...
spawn_t	spawns[] = {
	...
	{"info_domination_base", SP_info_domination_base},
	...
	{"func_door_new", SP_func_door_new},
	...
	{"trigger_door1", SP_trigger_doorX},
	{"trigger_door2", SP_trigger_doorX},
	...
	//[/Ladders]
	//[Domination]
/*	{"trigger_domination_field", SP_trigger_domination_field},


	{"misc_domination_a", SP_target_domination_a},
	{"misc_domination_b", SP_target_domination_b},
	{"misc_domination_c", SP_target_domination_c},*/
	//[/Domination]
	// targets perform no action by themselves, but must be triggered
	// by another entity
	{"target_give", SP_target_give},
	{"target_escape_point", SP_target_escape_point},
	{"target_escape_zone", SP_target_escape_point}, //FIXMEFIXED: remember what the hell it's called
	{"target_remove_powerups", SP_target_remove_powerups},
	{"target_delay", SP_target_delay},
	{"target_speaker", SP_target_speaker},
	{"target_print", SP_target_print},
	{"target_event", SP_target_event},
...
void G_SpawnGEntityFromSpawnVars( qboolean inSubBSP ) {
	...
	G_SpawnInt( "vipflag", "0", &i );
	//eezstreet edit: Commander Escort/VIP Special Flag
	if(i && (g_gametype.integer != GT_VIP_ESCORT || g_gametype.integer != GT_COMMANDER)){
		G_FreeEntity( ent );
		return;
	}
	else if(i == 1 && g_gametype.integer == GT_COMMANDER)
	{
		G_FreeEntity( ent );
		return;
	}
...
extern vmCvar_t	g_pregameLobbyMessage;
